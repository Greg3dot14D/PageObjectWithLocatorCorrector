...
public class LocatorCorrectorFieldDecorator extends DefaultFieldDecorator {
	...
	public LocatorCorrectorFieldDecorator(final SearchContext searchContext) {
		super(new LocatorCorrectorDefaultElementLocatorFactory(searchContext, new LocatorCorrector()));
	}
    ...
    public Object decorate(final ClassLoader loader, final Field field) {
    	System.out.println("decorate field :" + field.toString());
    ...
    private Object decorateContainer(final ClassLoader loader, final Field field) {
        ...
        PageFactory.initElements(new LocatorCorrectorFieldDecorator(wrappedElement), container);
        return container;
    }
}
